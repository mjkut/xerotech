...
{/* Action Buttons
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    className="flex-1 px-6 py-3 bg-gray-700/50 text-white rounded-lg hover:bg-gray-600/50 transition-colors duration-300 text-center flex items-center justify-center gap-2 border border-gray-600/50 hover:border-gray-500"
                  >
